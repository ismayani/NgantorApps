...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Edit Data Gaji</h2>
            <p class="section-lead">Edit Gaji</p>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/gaji/update/<?= $gaji['id_gaji']; ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <input type="hidden" name="id_gaji" value="<?= $gaji['id_gaji']; ?>">
                                <div class="form-group row">
                                    <label for="id_gaji" class="col-sm-3">ID Gaji</label>
                                    <div class="col-sm-8">
                                        <input disabled type="text" class="form-control <?= ($validation->hasError('id_gaji')) ?
                                                                                            'is-invalid' : ''; ?>" id="id_gaji" name="id_gaji" autofocus value="<?= (old('id_gaji'))
                                                                                                                                                                    ? (old('id_gaji')) : $gaji['id_gaji'] ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="id_tunjangan" name="id_tunjangan" class="custom-select border-transparent" data-style="btn btn-link">
                                            <option id="id_tunjangan" name="id_tunjangan" selected>Pilih ID Tunjangan..
                                                <?php
                                                $con = new mysqli("localhost", "root", "", "10119265_kepegawaian");
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control <?= ($validation->hasError('gaji_pokok')) ?
                                                                                    'is-invalid' : ''; ?>" id="gaji_pokok" name="gaji_pokok" autofocus value="<?= (old('gaji_pokok'))
                                                                                                                                                                    ? (old('gaji_pokok')) : $gaji['gaji_pokok'] ?>">
                                        <div class="invalid-feedback">
